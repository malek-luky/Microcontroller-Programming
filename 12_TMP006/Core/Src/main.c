...
/* USER CODE BEGIN PV */
static const uint8_t TMP006_ADDR = 0x40 << 1; //Use 8-bit, we need 7-bit
  ...
  while (1)
  {
	...
	if (ret != HAL_OK) {
		...
		if (ret != HAL_OK) {
			...
			// buf[0] 1100 1011 << 6 = 0011 0010 1100 0000
			// buf[1] 1111 1100 >> 2 = 0000 0000 0011 1111

			if ( val > 0x7FFF ) //aka if is negative
			{
